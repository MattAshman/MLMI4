...
def main(args):
    ...
    outname1 = '../i_tmp/' + args.dataset + '_' + str(args.num_layers) + '_'\
    ...
    outname2 = '../i_tmp/' + args.dataset + '_' + str(args.num_layers) + '_'\
            + str(args.num_inducing) + '.nll'
    outfile2 = open(outname2, 'w')
    outname3 = '../i_tmp/' + args.dataset + '_' + str(args.num_layers) + '_'\
